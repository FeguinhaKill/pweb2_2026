        ...
        <div class="col">
            <form action="{{ route('curso.search') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('curso/report') }}" class="btn btn-secondary"> Relatório Cursos</a>
                    </div>
                    <div class="col-md-3">
                        <a href="{{ url('curso/reportMatriculados') }}" class="btn btn-secondary"> Relatório Matriculados Cursos</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    @foreach ($dados as $item)
                        <tr>
                            ...
                            <td>{{ $item->valor }}</td>
                            <td><a href="{{ route('curso.turmas', $item->id) }}" class="btn btn-primary">Ver Turma
                                    {{ $item->turmas->count() }} </a></td>
